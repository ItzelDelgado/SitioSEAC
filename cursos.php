  ...
  <div class="container">
    <div class="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 gap-[30px]">
      ...
      <div class="group curso enCurso">
        <div class="imagen-container">
          ...
          <div class="absolute left-0 bottom-0 opacity-0 group-hover:opacity-100 duration-500 ease-in-out">
            <div class="pb-4 pl-4 flex items-center">
              <img src="assets/images/instructores/usr-m.jpg" class="h-12 w-12 rounded-full shadow-md dark:shadow-gray-800 mx-auto" alt="" />
              <div class="ml-3">
                <a href="assets/curriculums_docentes/JorgeAMorenoHern.pdf" class="font-semibold text-white block hover:text-indigo-600" target="_blank">M. en C. Jorge A.
                  Moreno Hernández
                </a>
        ...
        <div>
          <a href="cursos/Bioestadistica16.php" class="text-lg font-bold block hover:text-red-600 duration-500 ease-in-out mt-2 cursor-pointer">
            Bioestadística</a>
          ...
          <p>
            <a href="cursos/Bioestadistica16.php" target="_blank" class="btn btn-link text-indigo-600 hover:text-red-600 after:bg-indigo-600 duration-500 ease-in-out">Ver
              curso</a>
          </p>
      ...
      <div class="group curso enCurso">
        <div class="imagen-container">
          ...
          <div class="absolute left-0 bottom-0 opacity-0 group-hover:opacity-100 duration-500 ease-in-out">
            <div class="pb-4 pl-4 flex items-center">
              ...
              <div class="ml-3">
                <a href="assets/curriculums_docentes/MaLourdesBarbosaSal.pdf" class="font-semibold text-white block hover:text-indigo-600" target="_blank">Dra. María de Lourdes
                  Barbosa
                </a>
                <span class="text-white/70 text-sm">Doctora en Ciencias Biológicas</span>
              </div>
              <div class="ml-3">
                <a href="assets/curriculums_docentes/MaGuadalupeCamachoSan.pdf" class="font-semibold text-white block hover:text-indigo-600" target="_blank">Biol. María Guadalupe
                  Camacho</a>
        ...
        <div class="content p-6 relative">
          <a href="cursos/EstadisticaAplicadaAlDiseñoyAnalisisDeEstudiosExperimentales17.php" class="text-lg font-bold block hover:text-red-600 duration-500 ease-in-out mt-2 cursor-pointer">
          ...
          <p>
            <a href="cursos/EstadisticaAplicadaAlDiseñoyAnalisisDeEstudiosExperimentales17.php" target="_blank" class="btn btn-link text-indigo-600 hover:text-red-600 after:bg-indigo-600 duration-500 ease-in-out">Ver
              curso</a>
          </p>
          <ul class="pt-4 border-t border-gray-100 dark:border-gray-800 flex items-center list-none text-slate-400">
            <li class="flex items-center mr-3">
      ...
      <div class="group relative rounded-md shadow hover:shadow-lg dark:shadow-gray-800 duration-500 ease-in-out overflow-hidden enCurso">
        <div class="relative overflow-hidden">
          ...
          <div class="absolute left-0 bottom-0 opacity-0 group-hover:opacity-100 duration-500 ease-in-out">
            <div class="pb-4 pl-4 flex items-center">
              <img src="assets/images/instructores/usr-f.jpg" class="h-12 w-12 rounded-full shadow-md dark:shadow-gray-800 mx-auto" alt="" />
              <div class="ml-3">
                <a href="assets/curriculums_docentes/IramaMariselaNunezTancredi.pdf" class="font-semibold text-white block hover:text-indigo-600" target="_blank">Dra. Irama Silvia
        ...
        <div class="content p-6 relative">
          <a href="cursos/EstrategiasdeEduAmbientalParaSustentabilidad2daEd.php" class="text-lg font-bold block hover:text-red-600 duration-500 ease-in-out mt-2 cursor-pointer">
          ...
          <p>
            <a href="cursos/EstrategiasdeEduAmbientalParaSustentabilidad2daEd.php" target="_blank" class="btn btn-link text-indigo-600 hover:text-red-600 after:bg-indigo-600 duration-500 ease-in-out">Ver
              curso</a>
          </p>
          <ul class="pt-4 border-t border-gray-100 dark:border-gray-800 flex items-center list-none text-slate-400">
            <li class="flex items-center mr-3">
      ...
      <div class="group relative rounded-md shadow hover:shadow-lg dark:shadow-gray-800 duration-500 ease-in-out overflow-hidden programados">
        ...
        <div class="content p-6 relative">
          <a href="cursos/IntroduccionAlaDivulgacionDeLaCiencia6taED.php" class="text-lg font-bold block hover:text-red-600 duration-500 ease-in-out mt-2 cursor-pointer">
          ...
          <p>
            <a href="cursos/IntroduccionAlaDivulgacionDeLaCiencia6taED.php" target="_blank" class="btn btn-link text-indigo-600 hover:text-red-600 after:bg-indigo-600 duration-500 ease-in-out">Ver
              curso</a>
          </p>
          <ul class="pt-4 border-t border-gray-100 dark:border-gray-800 flex items-center list-none text-slate-400">
            <li class="flex items-center mr-3">
      ...
      <div class="group relative rounded-md shadow hover:shadow-lg dark:shadow-gray-800 duration-500 ease-in-out overflow-hidden programados">
        <div class="relative overflow-hidden">
          ...
          <div class="absolute left-0 bottom-0 opacity-0 group-hover:opacity-100 duration-500 ease-in-out">
            <div class="pb-4 pl-4 flex items-center">
              <img src="assets/images/instructores/usr-f.jpg" class="h-12 w-12 rounded-full shadow-md dark:shadow-gray-800 mx-auto" alt="" />
              <div class="ml-3">
                <a href="assets/curriculums_docentes/RosaliaPastorNieto.pdf" class="font-semibold text-white block hover:text-indigo-600" target="_blank">Dra. Rosalía Pastor
                  Nieto
                </a>
              </div>
            </div>
        ...
        <div class="content p-6 relative">
          <a href="cursos/RescateyRehabilitaciondeFaunaSilvestre6taEd.php" class="text-lg font-bold block hover:text-red-600 duration-500 ease-in-out mt-2 cursor-pointer">
          ...
          <p>
            <a href="cursos/RescateyRehabilitaciondeFaunaSilvestre6taEd.php" target="_blank" class="btn btn-link text-indigo-600 hover:text-red-600 after:bg-indigo-600 duration-500 ease-in-out">Ver
              curso</a>
          </p>
          <ul class="pt-4 border-t border-gray-100 dark:border-gray-800 flex items-center list-none text-slate-400">
            <li class="flex items-center mr-3">
      ...
      <div class="group relative rounded-md shadow hover:shadow-lg dark:shadow-gray-800 duration-500 ease-in-out overflow-hidden programados">
        <div class="relative overflow-hidden">
          ...
          <div class="absolute left-0 bottom-0 opacity-0 group-hover:opacity-100 duration-500 ease-in-out">
            <div class="pb-4 pl-4 flex items-center">
              <img src="assets/images/instructores/usr-f.jpg" class="h-12 w-12 rounded-full shadow-md dark:shadow-gray-800 mx-auto" alt="" />
              <div class="ml-3">
                <a href="assets/curriculums_docentes/GraciaPatriciaGonzalesPor.pdf" class="font-semibold text-white block hover:text-indigo-600" target="_blank">Dra. Gracia Patricia
                  González Porter
                </a>
        ...
        <div class="content p-6 relative">
          <a href="cursos/IntroduccionAlEstudioyConservaciondeTortugas1raEd.php" class="text-lg font-bold block hover:text-red-600 duration-500 ease-in-out mt-2 cursor-pointer">
      ...
      <div class="group relative rounded-md shadow hover:shadow-lg dark:shadow-gray-800 duration-500 ease-in-out overflow-hidden programados">
        <div class="relative overflow-hidden">
          ...
          <div class="absolute left-0 bottom-0 opacity-0 group-hover:opacity-100 duration-500 ease-in-out">
            <div class="pb-4 pl-4 flex items-center">
              <img src="assets/images/instructores/usr-m.jpg" class="h-12 w-12 rounded-full shadow-md dark:shadow-gray-800 mx-auto" alt="" />
              <div class="ml-3">
                <a href="assets/curriculums_docentes/JesusJuradoMolina.pdf" class="font-semibold text-white block hover:text-indigo-600" target="_blank">Dr. Jesús Jurado
                  Molina</a>
        ...
        <div class="content p-6 relative">
          <a href="cursos/IntroduccionAlaProgRyAplicAlinfereniciaEstadI_15aEd.php" class="text-lg font-bold block hover:text-red-600 duration-500 ease-in-out mt-2 cursor-pointer">
          ...
          <p>
            <a href="cursos/IntroduccionAlaProgRyAplicAlinfereniciaEstadI_15aEd.php" target="_blank" class="btn btn-link text-indigo-600 hover:text-red-600 after:bg-indigo-600 duration-500 ease-in-out">Ver
              curso</a>
          </p>
          <ul class="pt-4 border-t border-gray-100 dark:border-gray-800 flex items-center list-none text-slate-400">
            <li class="flex items-center mr-3">
      ...
      <div class="group relative rounded-md shadow hover:shadow-lg dark:shadow-gray-800 duration-500 ease-in-out overflow-hidden programados">
        <div class="relative overflow-hidden">
          <img src="assets/images/cursos/EstadisticaEnBiologia1.webp" class="group-hover:scale-110 duration-500 ease-in-out" alt="" />
          <div class="absolute inset-0 bg-slate-900/50 opacity-0 group-hover:opacity-100 duration-500 ease-in-out">
          </div>
          <div class="absolute left-0 bottom-0 opacity-0 group-hover:opacity-100 duration-500 ease-in-out">
            <div class="pb-4 pl-4 flex items-center">
              <img src="assets/images/instructores/usr-m.jpg" class="h-12 w-12 rounded-full shadow-md dark:shadow-gray-800 mx-auto" alt="" />
              <div class="ml-3">
                <a href="assets/curriculums_docentes/AlejandroVillegasCastillo.pdf" class="font-semibold text-white block hover:text-indigo-600" target="_blank">Dr. Alejandro Villegas
                  Castillo</a>
        ...
        <div class="content p-6 relative">
          <a href="cursos/IntroduccionEstadisticaEnBiologia_2daEd.php" class="text-lg font-bold block hover:text-red-600 duration-500 ease-in-out mt-2 cursor-pointer">
          ...
          <p>
            <a href="cursos/IntroduccionEstadisticaEnBiologia_2daEd.php" target="_blank" class="btn btn-link text-indigo-600 hover:text-red-600 after:bg-indigo-600 duration-500 ease-in-out">Ver
              curso</a>
          </p>
          <ul class="pt-4 border-t border-gray-100 dark:border-gray-800 flex items-center list-none text-slate-400">
            <li class="flex items-center mr-3">
      ...
      <div class="group relative rounded-md shadow hover:shadow-lg dark:shadow-gray-800 duration-500 ease-in-out overflow-hidden programados">
        <div class="relative overflow-hidden">
          <img src="assets/images/cursos/Excel1.webp" class="group-hover:scale-110 duration-500 ease-in-out" alt="" />
          <div class="absolute inset-0 bg-slate-900/50 opacity-0 group-hover:opacity-100 duration-500 ease-in-out">
          </div>
          <div class="absolute left-0 bottom-0 opacity-0 group-hover:opacity-100 duration-500 ease-in-out">
            <div class="pb-4 pl-4 flex items-center">
        ...
        <div class="content p-6 relative">
          <a href="/cursos/ExcelUsoyAplicaciones.php" class="text-lg font-bold block hover:text-red-600 duration-500 ease-in-out mt-2 cursor-pointer">
          ...
          <p>
            <a href="/cursos/ExcelUsoyAplicaciones.php" target="_blank" class="btn btn-link text-indigo-600 hover:text-red-600 after:bg-indigo-600 duration-500 ease-in-out">Ver
              curso</a>
          </p>
          <ul class="pt-4 border-t border-gray-100 dark:border-gray-800 flex items-center list-none text-slate-400">
            <li class="flex items-center mr-3">
