...
?>
    ...
    <!-- Start Hero -->
    <section
        class="relative table w-full py-36 lg:py-44 bg-[url('../../assets/images/slider/bg_inscripcion_convenios.webp')] bg-no-repeat bg-center">
    ...
    <section class="relative bg-gray-50 dark:bg-slate-800 mb-16 pt-12" id="inscripcion">
        <div class="container">
            ...
            <div class="pb-16 grid grid-cols-1 mt-4 mb-10">
                ...
                <h5 class="title mb-1 break-all">(En este caso no viene mas información de como es el proceso de incripción, pues
                    redirige al proceso de la secretaría, tampoco vienen los datos de buceo)
                    https://educontinua.fciencias.unam.mx/SiteNuevo/Cursos/Buceo/Intro.php</h5>
                ...
                <h5 class="title mb-1">Para mayores informes sobre el proceso de inscripción y pago:
                    <ol class="pl-10" style="list-style-type:circle;">
                        ...
                        <li>Sitio web: <a class="font-semibold text-indigo-600 hover:text-red-600 after:bg-indigo-600"
                                href="http://www.ceja.org.mx/">www.ceja.org.mx</a></li>
