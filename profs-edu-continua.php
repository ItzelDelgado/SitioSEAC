...
<div class="container">
  ...
  <ul class="list-decimal">
    <li>
      <h3 class="font-semibold mb-4 mt-10">
        Documento con descripción del curso, Taller o Diplomado.
        <a class="text-indigo-600" href="assets/pdf/formatos/FormatoPresentacionCursoo.docx" download="Documento-con-descripcion">Bajar formato</a>
      </h3>
    </li>
    <li>
      <h3 class="font-semibold mb-4 mt-10">
        Curriculum Vitae
        <a class="text-indigo-600" href="assets/pdf/formatos/Formato_CV.docx" download="Documento-con-descripcion">Bajar formato</a>
      </h3>
    </li>
  </ul>
  ...
  <div class="mt-10 mb-10">
    ...
    <ul class="pl-4 list-disc">
      <li>
        Correo electrónico:
        <a class="text-indigo-600" href="mailto:educontinua.inf@ciencias.unam.mx">educontinua.inf@ciencias.unam.mx</a>
      </li>
      <li>
