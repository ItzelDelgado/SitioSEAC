...
$titulo_curso = "Curso Programación de dispositivos móviles con Android";
$imagen_curso = "../../../assets/images/cursos/Programacion-de-Dispositivos-Moviles-con-Android.webp"; //Agregar imagen del curso, tamaño forzoso de 19
$edicion = "1ra. Edición";
...
$horario = "10:00 a 1:00 hrs"; //Lo puedes poner en el formato que gustes. No debe ser mucha info. 
...
$requisitos = "Los alumnos deberán traer una laptop. Tener conocimientos básicos de programación en Java";
...
$info_academica = "M. en C. Gustavo Márquez Flores <br> Correo electrónico: gmarquez@ciencias.unam.mx"; //Agregar el Nombre <br> correo, dando un br para saltar de linea.
$ponentes_principales_presentacion = array(array("M. en C. Gustavo Márquez Flores", "../../../assets/curriculums_docentes/CV_GustavoMarquezFlores.pdf"))
    ...
    <div class="secciones grid md:grid-cols-2 grid-cols-1">
        <div> <!--Tema-->
            ...
            <div class="contenido">
                ...
                <ul>
                    ...
                    <li>I.2. Clasificación y aplicaciones de los dispositivos móviles.</li>
        ...
        <div> <!--Tema-->
            ...
            <div class="contenido">
                <h4>Temas</h4>
                <ul>
                    <li>I.1 Instalación y configuración del entorno de desarrollo (Android Studio y SDK Android).</li>
                    <li>I.2. Elementos esenciales en la creación de aplicaciones Android.
                        <ul>
                            <li>Activity, Context y Ciclos de vida de Activities</li>
                        </ul>
                    </li>
                    <li>I.3. Interfaz de usuario.
                        <ul>
                            <li>Layouts, recursos, ActionBar, menús, listas, popups, webview, fragmentos, pestañas, etc.</li>
                        </ul>
                    </li>
                    <li>I.4. Gestión de la navegación y la comunicación entre las distintas interfaces.
                        <ul>
                            <li>Material Design, Toolbar, CardView, notificaciones Android Wear.</li>
                        </ul>
                    </li>
                    <li>I.5. Interfaces Personalizadas.
                        <ul>
                            <li>Gestión de temas, animaciones, tipografía.</li>
                        </ul>
                    </li>
                    <li>I.6. Gestión de los distintos eventos de usuario.
                        <ul>
                            <li>Clicks y rotación.</li>
                        </ul>
                    </li>
                </ul>
            </div>
        ...
        <div> <!--Tema-->
            ...
            <div class="contenido">
                <h4>Temas</h4>
                <ul>
                    <li>I.1. Versiones de Android, tamaño y resolución de pantallas, diferencias en el hardware.</li>
                </ul>
            </div>
        </div><!--fin de tema-->
        <div> <!--Tema-->
            ...
            <div class="contenido">
                <h4>Temas</h4>
                <ul>
                    <li>I.1. Servicios web, gestión de la conectividad, parsing Xml / Json.
                        <ul>
                            <li>Shared Preferences, archivos, base de datos SQLite.</li>
                        </ul>
                    </li>
                    <li>I.2. Compartir datos con otras aplicaciones.
                        <ul>
        ...
        <div> <!--Tema-->
            ...
            <div class="contenido">
                <h4>Temas</h4>
                <ul>
                    <li>I.1. Google Maps, localización (GPS), conversión posición/dirección.</li>
                    <li>I.2. Uso de servicios Android.</li>
                    <li>I.3. Conectividad (WIFI).</li>
                </ul>
            </div>
        </div><!--fin de tema-->
        <div> <!--Tema-->
            ...
            <div class="contenido">
                <h4>Temas</h4>
                <ul>
                    <li>I.1. Llamadas, sms, cámara, acelerómetro, Bluetooth.</li>
                </ul>
            </div>
        </div><!--fin de tema-->
        <div> <!--Tema-->
            ...
            <div class="contenido">
                <h4>Temas</h4>
                <ul>
                    <li>I.1. Proteger el código fuente.</li>
                    <li>Comercialización de aplicaciones.</li>
                </ul>
            </div>
        </div><!--fin de tema-->
