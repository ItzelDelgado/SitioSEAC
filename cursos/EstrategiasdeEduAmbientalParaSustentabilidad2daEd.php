...
?>
    ...
    <!-- Start Hero -->
    <section
        class="relative table w-full py-36 lg:py-44 bg-[url('../../assets/images/cursos/bg-estrategias-edu-ambiental-para-sustentabilidad.webp')] bg-no-repeat bg-center">
        <div class="absolute inset-0 bg-black opacity-75"></div>
        <div class="container">
            <div class="grid grid-cols-1 pb-8 text-center mt-10">
                <span class="bg-green-600 text-white text-xs font-bold px-2.5 py-0.5 rounded w-fit mx-auto h-5">$4,800 /
                    UNAM</span>
                <span class="bg-blue-900 text-white text-xs font-bold px-2.5 py-0.5 rounded w-fit mx-auto h-5">$5,700 /
                    GENERAL</span>
                <h3 class="mt-3 text-3xl leading-normal font-medium text-white">Estrategias de educación ambiental para la sustentabilidad</h3>
                ...
                <div class="flex items-center mx-auto mt-3">
                    ...
                    <a href="/assets/curriculums_docentes/IramaMariselaNunezTancredi.pdf"
                        class="font-semibold text-white block ml-3 hover:text-indigo-600" target="_blank">Dra. Irama Silvia Marisela Núñez Tancredi</a>
                    <a href="/assets/curriculums_docentes/StepChantalSeguraEspi.pdf"
                        class="font-semibold text-white block ml-3 hover:text-indigo-600" target="_blank">Lic. Stephanie Chantal Segura Espinosa</a>
                    <a href="/assets/curriculums_docentes/AngelRodrigoGonzalezGonzalez.pdf"
                        class="font-semibold text-white block ml-3 hover:text-indigo-600" target="_blank">M. en C. Ángel Rodrigo González González</a>
                </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-1 gap-[30px]">
                ...
                <div class="text-center px-6 mt-6">
                    ...
                    <div class="content mt-7">
                        ...
                        <p class="text-slate-400 mt-3">Personas involucradas en procesos educativos formales e informales e interesadas en educación ambiental y público en general.</p>
                    </div>
                </div>
                ...
                <div class="text-center px-6 mt-6">
                    ...
                    <div class="content mt-7">
                        ...
                        <p class="text-slate-400 mt-3">Sesiones presenciales: Sábados<br>
                            Horario: 10:00 a 13:00 hrs.</p>
                        <p class="text-slate-400 mt-3">Sesiones en línea: Classroom<br>
                            Horario: Abierto</p>
                ...
                <div class="text-center px-6 mt-6">
                    ...
                    <div class="content mt-7">
                        ...
                        <div class="mt-5">
                            <a href="#"
                                class="btn btn-link text-indigo-600 hover:text-red-600 after:bg-indigo-600 duration-500 ease-in-out">Classroom</a>
                        </div>
                        <p class="text-slate-400 mt-3">Modalidad presencial</p>
                        <div class="mt-5">
                            <a href="#"
                                class="btn btn-link text-indigo-600 hover:text-red-600 after:bg-indigo-600 duration-500 ease-in-out">Secretaría de Educación Abierta y Continua</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid lg:grid-cols-2 md:grid-cols-2 mt-8 gap-[30px]">
                        <div
                            ...
                            <div class="flex mb-5">
                                ...
                                <span class="price text-4xl font-semibold mb-0">5,700</span>
                        ...
                        <div
                            ...
                            <div class="flex mb-5">
                                <span class="text-xl font-semibold">$</span>
                                <span class="price text-4xl font-semibold mb-0">4,800</span>
                                <span class="text-xl font-semibold self-end mb-1">MXN</span>
                            </div>

                            <ul class="list-none text-slate-400">
                                <li class="mb-1 flex"><i
                                        class="uil uil-check-circle text-indigo-600 text-xl mr-2"></i>Alumnos, exalumnos, personal de la UNAM y tesistas de la UNAM.</li>
                                <li class="mb-1 flex"><i
    ...
    <section class="relative">
        ...
        <div class="container">
            ...
            <div class="grid md:grid-cols-2 grid-cols-1 pt-6 gap-[30px]">
                <div>
                    <h5 class="text-lg uppercase font-semibold mb-5">I. Panorama actual de la situación socioecológica </h5>
                        ...
                        <table class="w-full text-left">
                            ...
                            <tbody>
                                <tr class="border-t border-gray-100 dark:border-gray-700">
                                    <td class="p-4"><i class="uil uil-clipboard-alt"></i> I.1 Breve revisión de la crisis de la modernidad</td>
                                    <td class="p-4 text-right"></td>
                                </tr>

                                <tr class="border-t border-gray-100 dark:border-gray-700">
                                    <td class="p-4"><i class="uil uil-clipboard-alt"></i> I.2 Los problemas enredados (wicked problems) y el enfoque transdisciplinario </td>
                                    <td class="p-4 text-right"></td>
                                </tr>

                                <tr class="border-t border-gray-100 dark:border-gray-700">
                                    <td class="p-4"><i class="uil uil-clipboard-alt"></i> I.3 El enfoque biocultural como alternativa a la crisis de la modernidad</td>
                                    <td class="p-4 text-right"></td>
                                </tr>

                                <tr class="border-t border-gray-100 dark:border-gray-700">
                                    <td class="p-4"><i class="uil uil-clipboard-alt"></i> Revisión del entorno donde los participantes pretenden desarrollar la estrategia de EAS</td>
                                    <td class="p-4 text-right"></td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <div>
                    <h5 class="text-lg uppercase font-semibold mb-5">II. ¿Qué es educación ambiental?</h5>
                    ...
                    <div
                        ...
                        <table class="w-full text-left">
                            ...
                            <tbody>
                                <tr class="border-t border-gray-100 dark:border-gray-700">
                                    <td class="p-4"><i class="uil uil-clipboard-alt"></i>II.1 Modelos educativos (conductismo, constructivismo, aprendizaje basado en problemas, etc.)</td>
                                </tr>

                                <tr class="border-t border-gray-100 dark:border-gray-700">
                                    <td class="p-4"><i class="uil uil-clipboard-alt"></i>II.2 Elementos característicos y dimensiones de la educación ambiental</td>

                                </tr>
                                <tr class="border-t border-gray-100 dark:border-gray-700">
                                    <td class="p-4"><i class="uil uil-clipboard-alt"></i>II.3 Paradigmas de la Investigación ambiental (positivismo, teoría crítica, interpretativismo)</td>

                                </tr>
                                <tr class="border-t border-gray-100 dark:border-gray-700">
                                    <td class="p-4"><i class="uil uil-clipboard-alt"></i>II.4 Enfoques de la EA (instrumental, crítico-social, subversión, transgresión)</td>

                                </tr>
                                <tr class="border-t border-gray-100 dark:border-gray-700">
                                    <td class="p-4"><i class="uil uil-clipboard-alt"></i>II.5 Propuesta inicial de la estrategia a desarrollar</td>
                ...
                <div>
                    <h5 class="text-lg uppercase font-semibold mb-5">III. La perspectiva socio-ecológica y la sustentabilidad
                    </h5>
                    ...
                    <div
                        ...
                        <table class="w-full text-left">
                            ...
                            <tbody>
                                <tr class="border-t border-gray-100 dark:border-gray-700">
                                    <td class="p-4"><i class="uil uil-clipboard-alt"></i>III.1 Puntos de apalancamiento para la sustentabilidad</td>
                                </tr>

                                <tr class="border-t border-gray-100 dark:border-gray-700">
                                    <td class="p-4"><i class="uil uil-clipboard-alt"></i>III.2 Los Objetivos del desarrollo sustentable</td>
                                </tr>

                                <tr class="border-t border-gray-100 dark:border-gray-700">
                                    <td class="p-4"><i class="uil uil-clipboard-alt"></i>III.3 Capacidades para la sustentabilidad
                                    </td>
                                </tr>
                                <tr class="border-t border-gray-100 dark:border-gray-700">
                                    <td class="p-4"><i class="uil uil-clipboard-alt"></i>III.4 Profundización en el contexto y entorno de la estrategia de EAS
                                    </td>
                                </tr>
                ...
                <div>
                    <h5 class="text-lg uppercase font-semibold mb-5">IV. Metodología y recursos para la implementación de la estrategia de EAS: Los enfoques participativos </h5>
                    ...
                    <div
                        ...
                        <table class="w-full text-left">
                            ...
                            <tbody>
                                <tr class="border-t border-gray-100 dark:border-gray-700">
                                    <td class="p-4"><i class="uil uil-clipboard-alt"></i> IV.1 Aprendizaje social, Investigación Acción Participativa, co-manejo adaptativo del territorio</td>

                                </tr>

                                <tr class="border-t border-gray-100 dark:border-gray-700">
                                    <td class="p-4"><i class="uil uil-clipboard-alt"></i>IV.2 Ecociudadanía</td>

                                </tr>
                                <tr class="border-t border-gray-100 dark:border-gray-700">
                                    <td class="p-4"><i class="uil uil-clipboard-alt"></i>IV.2 Ecología cívica</td>
                ...
                <div>
                    <h5 class="text-lg uppercase font-semibold mb-5">V.  Presentación de las estrategias de EAS
                    </h5>
                </div>
                    ...
                    <div
                        ...
                        <div class="grid md:grid-cols-2">
                            ...
                            <div class="float-left text-left md:ml-8 mt-6 md:mt-0">
                                ...
                                <p class="mt-1 mb-0 text-slate-400"><a href="https://tienda.fciencias.unam.mx"
                                        target="_blank"
                                        class="btn btn-link text-indigo-600 hover:text-red-600 after:bg-indigo-600 duration-500 ease-in-out">tienda.fciencias.unam.mx</a>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="grid md:grid-cols-2 mt-10">
                            ...
                            <div class="float-left text-left md:ml-8 mt-6 md:mt-0">
                                ...
                                <p class="mt-1 mb-0 text-slate-400"><a href="https://forms.gle/EecbsbhoM6DSAsqj9"
                                        target="_blank"
                                        class="btn btn-link text-indigo-600 hover:text-red-600 after:bg-indigo-600 duration-500 ease-in-out">Formato
                                        de inscripción</a></p>
                            </div>
                        </div>
            ...
            <div>
                <div class="relative shadow dark:shadow-gray-800 rounded-md overflow-hidden mt-4">
                    ...
                    <div id="info-acad" class="hidden" aria-labelledby="info-acad-col">
                        <div class="p-5">
                            <p class="text-slate-400 dark:text-gray-400">Dra. Irama Silvia Marisela Núñez Tancredi<br>
                                Correo electrónico: irama@ciencias.unam.mx</p>
                        </div>
                    </div>
                </div>
            </div>
