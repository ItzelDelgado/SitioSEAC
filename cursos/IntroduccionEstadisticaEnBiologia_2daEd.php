    ...
    <section class="relative md:py-24 py-16 overflow-hidden">
        <div class="container">
            <div class="grid grid-cols-1">
                ...
                <p class="mb-3">A menudo la formación que han recibido durante la carrera los jóvenes investigadores
            ...
            <div class="grid grid-cols-1">
                ...
                <p class=" mb-3">Aprender a identificar, usar y aplicar correctamente las pruebas estadísticas en un
                    contexto biológico.
                </p>
            </div><!--end grid-->
            ...
            <div class="grid grid-cols-1">
                ...
                <p class=" mb-3">Estudiantes, profesionistas, tomadores de decisiones, manejadores de recursos,
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-1 gap-[30px]">
                ...
                <div class="text-center px-6 mt-6">
                    ...
                    <div class="content mt-7">
                        ...
                        <p class="text-slate-400 mt-3">Licenciatura</p>
                ...
                <div class="text-center px-6 mt-6">
                    ...
                    <div class="content mt-7">
                        ...
                        <p class="text-slate-400 mt-3">Lunes, miércoles y viernes.<br>
                    ...
                    <div class="grid lg:grid-cols-2 md:grid-cols-2 mt-8 gap-[30px]">
                        <div
                            ...
                            <div class="flex mb-5">
                                ...
                                <span class="price text-4xl font-semibold mb-0">2,500</span>
                        ...
                        <div
                            ...
                            <div class="flex mb-5">
                                <span class="text-xl font-semibold">$</span>
                                <span class="price text-4xl font-semibold mb-0">2,000</span>
                                <span class="text-xl font-semibold self-end mb-1">MXN</span>
                            </div>
    ...
    <section class="relative">
        ...
        <div class="container">
            ...
            <div class="grid md:grid-cols-2 grid-cols-1 pt-6 gap-[30px]">
                        ...
                        <table class="w-full text-left">
                            ...
                            <tbody>
                                <tr class="border-t border-gray-100 dark:border-gray-700">
                                    <td class="p-4"><i class="uil uil-clipboard-alt"></i> I.1 Conceptos básicos de
                                        estadística</td>
                                    <td class="p-4 text-right"></td>
                                </tr>

                                <tr class="border-t border-gray-100 dark:border-gray-700">
                                    <td class="p-4"><i class="uil uil-clipboard-alt"></i> I.2 Tipos de datos </td>
                                    <td class="p-4 text-right"></td>
                                </tr>

                                <tr class="border-t border-gray-100 dark:border-gray-700">
                                    <td class="p-4"><i class="uil uil-clipboard-alt"></i> I.3 Tipos de variables</td>
                                    <td class="p-4 text-right"></td>
                                </tr>
                ...
                <div>
                    <h5 class="text-lg uppercase font-semibold mb-5">II. Estadística descriptiva e inferencial </h5>
                    ...
                    <div
                        ...
                        <table class="w-full text-left">
                            ...
                            <tbody>
                                <tr class="border-t border-gray-100 dark:border-gray-700">
                                    <td class="p-4"><i class="uil uil-clipboard-alt"></i>II.1 Medidas de tendencia
                                        central</td>
                                    <td class="p-4 text-right"></td>
                                </tr>

                                <tr class="border-t border-gray-100 dark:border-gray-700">
                                    <td class="p-4"><i class="uil uil-clipboard-alt"></i>II.2 Medidas de dispersión</td>
                ...
                <div>
                    <h5 class="text-lg uppercase font-semibold mb-5">III. La varianza como base del análisis estadístico
                    </h5>
                    ...
                    <div
                        ...
                        <table class="w-full text-left">
                            ...
                            <tbody>
                                <tr class="border-t border-gray-100 dark:border-gray-700">
                                    <td class="p-4"><i class="uil uil-clipboard-alt"></i>III.1 Qué es y para qué sirve
                                        la varianza</td>
                                    <td class="p-4 text-right"></td>
                                </tr>

                                <tr class="border-t border-gray-100 dark:border-gray-700">
                                    <td class="p-4"><i class="uil uil-clipboard-alt"></i>III.2 Pruebas de
                                        homocedasticidad de varianzas</td>
                                    <td class="p-4 text-right"></td>
                                </tr>

                                <tr class="border-t border-gray-100 dark:border-gray-700">
                                    <td class="p-4"><i class="uil uil-clipboard-alt"></i>III.3 Prueba F para varianzas
                                    </td>
                                    <td class="p-4 text-right"></td>
                                </tr>
                ...
                <div>
                    <h5 class="text-lg uppercase font-semibold mb-5">IV. Pruebas de normalidad </h5>
                    ...
                    <div
                        ...
                        <table class="w-full text-left">
                            ...
                            <tbody>
                                <tr class="border-t border-gray-100 dark:border-gray-700">
                                    <td class="p-4"><i class="uil uil-clipboard-alt"></i> IV.1 Qué son y para qué sirven
                                        las pruebas de normalidad</td>
                                    <td class="p-4 text-right"></td>
                                </tr>

                                <tr class="border-t border-gray-100 dark:border-gray-700">
                                    <td class="p-4"><i class="uil uil-clipboard-alt"></i>IV.2 Pruebas de normalidad
                ...
                <div>
                    <h5 class="text-lg uppercase font-semibold mb-5">V. Estadística Paramétrica: Análisis de varianzas
                    </h5>
                    ...
                    <div
                        ...
                        <table class="w-full text-left">
                            ...
                            <tbody>
                                <tr class="border-t border-gray-100 dark:border-gray-700">
                                    <td class="p-4"><i class="uil uil-clipboard-alt"></i> V.1 ANOVA de una y dos vías
                                    </td>
                                    <td class="p-4 text-right"></td>
                                </tr>
                ...
                <div>
                    <h5 class="text-lg uppercase font-semibold mb-5">VI. Estadística no paramétrica: Análisis de
                        varianzas </h5>
                    ...
                    <div
                        ...
                        <table class="w-full text-left">
                            ...
                            <tbody>
                                <tr class="border-t border-gray-100 dark:border-gray-700">
                                    <td class="p-4"><i class="uil uil-clipboard-alt"></i> VI.1 -Prueba
                                        Kolmogorov-Smirnov</td>
                                    <td class="p-4 text-right"></td>
                                </tr>

                                <tr class="border-t border-gray-100 dark:border-gray-700">
                                    <td class="p-4"><i class="uil uil-clipboard-alt"></i>VI.2 Prueba Mann-Whitney</td>
                                    <td class="p-4 text-right"></td>
                                </tr>

                                <tr class="border-t border-gray-100 dark:border-gray-700">
                                    <td class="p-4"><i class="uil uil-clipboard-alt"></i>VI.3 Prueba Kruskal-Wallis</td>
                                    <td class="p-4 text-right"></td>
                                </tr>
                ...
                <div>
                    <h5 class="text-lg uppercase font-semibold mb-5">VII. Modelo Lineal (regresión) </h5>
                    ...
                    <div
                        ...
                        <table class="w-full text-left">
                            ...
                            <tbody>
                                <tr class="border-t border-gray-100 dark:border-gray-700">
                                    <td class="p-4"><i class="uil uil-clipboard-alt"></i> VII.1 Regresión lineal
                                        múltiple</td>
                                    <td class="p-4 text-right"></td>
                                </tr>

                                <tr class="border-t border-gray-100 dark:border-gray-700">
                                    <td class="p-4"><i class="uil uil-clipboard-alt"></i>VII.2 Regresión multivariada
                                        múltiple</td>
                                    <td class="p-4 text-right"></td>
                                </tr>
                ...
                <div>
                    <h5 class="text-lg uppercase font-semibold mb-5">VIII. Modelos multidimensionales </h5>
                    ...
                    <div
                        ...
                        <table class="w-full text-left">
                            ...
                            <tbody>
                                <tr class="border-t border-gray-100 dark:border-gray-700">
                                    <td class="p-4"><i class="uil uil-clipboard-alt"></i> VIII.1 Análisis de componentes
                                        principales</td>
                                    <td class="p-4 text-right"></td>
                                </tr>

                                <tr class="border-t border-gray-100 dark:border-gray-700">
                                    <td class="p-4"><i class="uil uil-clipboard-alt"></i>VIII.2 Análisis de
                                        correspondencia</td>
                                    <td class="p-4 text-right"></td>
                                </tr>
                ...
                <div>
                    <h5 class="text-lg uppercase font-semibold mb-5">IX. Modelos predictivos </h5>
                    ...
                    <div
                        ...
                        <table class="w-full text-left">
                            ...
                            <tbody>
                                <tr class="border-t border-gray-100 dark:border-gray-700">
                                    <td class="p-4"><i class="uil uil-clipboard-alt"></i> IX.1 Chi-cuadrada de bondad de
                                        ajuste</td>
                                    <td class="p-4 text-right"></td>
                                </tr>
                    ...
                    <div
                        ...
                        <div class="grid md:grid-cols-2 mt-10">
                            ...
                            <div class="float-left text-left md:ml-8 mt-6 md:mt-0">
                                ...
                                <p class="mt-1 mb-0 text-slate-400"><a href="https://forms.gle/gFuD2JAVD5ZQF3HR8"
                                        target="_blank"
                    ...
                    <div id="info-acad" class="hidden" aria-labelledby="info-acad-col">
                        <div class="p-5">
                            <p class="text-slate-400 dark:text-gray-400">Dr. Alejandro Villegas Castillo<br>
                                Correo electrónico: alejandrovillegas@ciencias.unam.mx</p>
                        </div>
                    </div>
                </div>
            </div>
