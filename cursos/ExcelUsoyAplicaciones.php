    ...
    <section class="relative md:py-20 py-16 overflow-hidden">
        <div class="container">
            ...
            <div class="grid grid-cols-1">
                ...
                <p class=" mb-3">Aprender el manejo de hojas de calculo de Excel y los principios de programación de Visual.
                </p>
            </div><!--end grid-->
            ...
            <div class="grid grid-cols-1">
                ...
                <p class=" mb-3"> Biólogos, Oceanógrafos, Contadores, Oceanólogos, economistas, físicos, matemáticos, estudiantes de postgrado, investigadores y profesionales en áreas multidisciplinarias.
                </p>
    ...
    <section class="relative md:py-14 py-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-1 gap-[30px]">
                ...
                <div class="text-center px-6 mt-6">
                    ...
                    <div class="content mt-7">
                        ...
                        <p class="text-slate-400 mt-3">Conocimientos básicos de estadística y cálculo diferencial.</p>
                ...
                <div class="text-center px-6 mt-6">
                    ...
                    <div class="content mt-7">
                        ...
                        <p class="text-slate-400 mt-3">Martes y jueves<br>
        ...
        <div class="container mt-20">
            <div class="grid grid-cols-1 pb-8 text-center">
                <h3 class="md:text-3xl md:leading-normal text-2xl leading-normal font-semibold">Costo</h3>
    ...
    <section class="relative md:py-24 py-16">
        ...
        <div class="container">
            ...
            <div class="grid md:grid-cols-2 grid-cols-1 pt-6 gap-[30px]">
                <div>
                    <h5 class="text-lg uppercase font-semibold mb-5">I. Hojas de calculo y graficación</h5>
                    ...
                    <div
                        ...
                        <table class="w-full text-left">
                            ...
                            <tbody>
                                ...
                                <tr class="border-t border-gray-100 dark:border-gray-700">
                                    <td class="p-4"><i class="uil uil-clipboard-alt"></i>I.2. Fórmulas</td>
                                    <td class="p-4 text-right"></td>
                                </tr>
                ...
                <div>
                    <h5 class="text-lg uppercase font-semibold mb-5">II. Manipulación de datos en Excel
                    </h5>
                    ...
                    <div
                        ...
                        <table class="w-full text-left">
                            ...
                            <tbody>
                                <tr class="border-t border-gray-100 dark:border-gray-700">
                                    <td class="p-4"><i class="uil uil-clipboard-alt"></i> II.1 Ordenación de datos
                                    </td>
                                    <td class="p-4 text-right"></td>
                                </tr>

                                <tr class="border-t border-gray-100 dark:border-gray-700">
                                    <td class="p-4"><i class="uil uil-clipboard-alt"></i>II.2 Filtración de datos
                                    </td>
                                ...
                                <tr class="border-t border-gray-100 dark:border-gray-700">
                                    <td class="p-4"><i class="uil uil-clipboard-alt"></i>II.3 Uso de criterios para filtración avanzada de datos
                                    </td>
                                    <td class="p-4 text-right"></i></td>
                                </tr>

                                <tr class="border-t border-gray-100 dark:border-gray-700">
                                    <td class="p-4"><i class="uil uil-clipboard-alt"></i>II.4 Tablas y tablas dinámicas
                                    </td>
                                    <td class="p-4 text-right"></i></td>
                                </tr>
                            </tbody>
                ...
                <div>
                    <h5 class="text-lg uppercase font-semibold mb-5">III. Documentos y compartiendo trabajo y documentos</h5>
                ...
                <div>
                    <h5 class="text-lg uppercase font-semibold mb-5">IV. Visual Basic</h5>
...
Cuenta: 572529<br>Clabe: 00 21 80 08 70 05 72 52 92<br>Referencia: 829.411.100</p>
    ...
    <div class="container md:mt-24 mt-16 mb-12">
        <div class="grid grid-cols-1 pb-8 text-center">
        ...
        <div id="accordion-collapse" data-accordion="collapse"
            class="grid md:grid-cols-2 grid-cols-1 md:gap-[30px]">
            <div>
