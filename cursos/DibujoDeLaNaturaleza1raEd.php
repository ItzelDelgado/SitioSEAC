...
?>
    ...
    <section class="relative md:py-20 py-16 overflow-hidden">
        <div class="container">
            <div class="grid grid-cols-1">
                ...
                <p class="mb-3">En todo el mundo, existen muy pocos cursos sobre el tema. En nuestro país no hay
            ...
            <div class="grid grid-cols-1">
                ...
                <p class=" mb-3">Desarrollar las habilidades personales en el campo del dibujo de la naturaleza y
            ...
            <div class="grid grid-cols-1">
                <h6 class="text-2xl font-semibold mb-5 mt-6">Material requerido a los alumnos</h6>

                <p class=" mb-3">Hojas de papel bond tamaño carta, lápices de dibujo 2 ó 3B y H o HB, papel fabriano,
            ...
            <div class="grid grid-cols-1">
                ...
                <p class=" mb-3"> El taller está dirigido a biólogos, ilustradores, artistas plásticos, artistas
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-1 gap-[30px]">
                ...
                <div class="text-center px-6 mt-6">
                    ...
                    <div class="content mt-7">
                        ...
                        <p class="text-slate-400 mt-3">Conocimientos básicos de dibujo.</p>
                ...
                <div class="text-center px-6 mt-6">
                    ...
                    <div class="content mt-7">
                        ...
                        <p class="text-slate-400 mt-3">Teoría:<br> Secretaría de Educación Abierta y Continua</p>
                        <p class="text-slate-400 mt-3">Práctica:<br>
                            ...
                            <div class="flex flex-col mb-5">
                                <div>
                                    ...
                                    <span class="price text-4xl font-semibold mb-0"
                                        style="text-decoration: line-through;">6,000</span>
                                    <span class="text-xl font-semibold self-end mb-1">MXN</span>
                                </div>
                                <div>
                                    <span class="text-xl font-semibold">$</span>
                                    <span class="price text-4xl font-semibold mb-0">5,100</span>
                                    <span class="text-xl font-semibold self-end mb-1">MXN</span>
                                </div>
                            </div>
                        ...
                        <div
                            ...
                            <div class="flex flex-col mb-5">
                                <div>
                                    <span class="text-xl font-semibold">$</span>
                                    <span class="price text-4xl font-semibold mb-0"
                                        style="text-decoration: line-through;">5,000</span>
                                    <span class="text-xl font-semibold self-end mb-1">MXN</span>
                                </div>
                                <div>
                                    <span class="text-xl font-semibold">$</span>
                                    <span class="price text-4xl font-semibold mb-0">4,250</span>
                                    <span class="text-xl font-semibold self-end mb-1">MXN</span>
                                </div>
                            </div>
    ...
    <section class="relative md:py-20 py-15">
                    ...
                    <div
                        ...
                        <div class="grid md:grid-cols-2 mt-10">
                            ...
                            <div class="float-left text-left md:ml-8 mt-6 md:mt-0">
                                ...
                                <p class="mt-1 mb-0 text-slate-400"><a href="https://forms.gle/SmrqLjnrbTyATXv99"
                                        target="_blank"
            ...
            <div>
                <div class="relative shadow dark:shadow-gray-800 rounded-md overflow-hidden mt-4">
                    ...
                    <div id="info-acad" class="hidden" aria-labelledby="info-acad-col">
                        <div class="p-5">
                            <p class="text-slate-400 dark:text-gray-400">Maestro Aldi de Oyarzabal Salcedo
                                <br>Correo electrónico: ao@ciencias.unam.mx
                            </p>
                        </div>
                    </div>
                </div>
