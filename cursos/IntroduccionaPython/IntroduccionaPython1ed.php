...
$imagen_curso = "../../../assets/images/cursos/introduccion-a-python.jpg"; //Agregar imagen del curso, tamaño forzoso de 19
$edicion = "1ra. Edición";
$fecha = "	Del 9 de agosto al 26 de agosto del 2023";
$precio_unam = "2,100"; //No es necesario poner mxn
...
$dias = "Miercoles, viernes y sábados"; //Puedes poner Lunes, Martes, Miercoles, Jueves y Viernes.
$horario = "Pre: Mie y vie de 19:00 a 21:00, Vir: Sáb de 10:00 a 13:00hrs."; //Lo puedes poner en el formato que gustes. No debe ser mucha info. 
...
$no_horas = "21"; //No es necesario poner hrs
$modalidad = "Híbrida";
$max_alumnos = "35"; //Cantidad de alumnos maxima
$min_alumnos = "15"; //Cantidad de alumnos minima
$descripcion = "Python es un lenguaje de programación que se ha vuelto muy popular en los últimos años debido a su facilidad de aprendizaje y a su amplia gama de aplicaciones. En particular, Python es muy popular en el ámbito de la ciencia de datos, ya que tiene una gran cantidad de bibliotecas y herramientas que son muy útiles para el análisis de datos y la creación de modelos predictivos.
La ciencia de datos es una disciplina que utiliza técnicas de estadística, matemáticas y ciencias de la computación para analizar datos y obtener información útil a partir de ellos. La ciencia de datos se ha vuelto cada vez más importante en la actualidad debido a la gran cantidad de datos que se generan en diferentes áreas, como la medicina, la industria, el comercio electrónico, entre otros. Además se espera que el requerimiento profesional en perfiles de ciencia de datos continúe en los próximos años. Una proyección realizada por el Bureau of Labour Statistics de Estados Unidos, espera un crecimiento de 36% en los trabajos de ciencia de datos durante el intervalo de años comprendido de 2021 a 2031.";
$objetivo = "Los participantes serán capaces de aplicar los conocimientos fundamentales de el lenguaje de programación Python, de manera que puedan utilizarlo de forma efectiva en la resolución de problemas y en la creación de proyectos de programación, además de ser capaces de entender las estructuras y elementos básicos de Python.";
$dirigido_a = "Egresados de Matemáticas, Física, Matemáticas Aplicadas, Actuaría, Ingenierías o cualquier profesionista con un conocimiento en álgebra lineal y cálculo diferencial e integral.";
$requisitos = "Estudiantes.";
$lugar = "<b>Sesiones en línea</b> por medio de Zoom. <br><b>Sesiones presenciales</b> en la sede Coapa de Fundación UNAM (Calz. Del Hueso 1021, Coapa, Col. Villa del Puente)."; //El lugar donde se va a impartir, si son varios, agregar todos y separar con <br>
$info_academica = "M. en C. Sergio Iker Martínez Juárez<br>
Correo electrónico: iker@ciencias.unam.mx"; //Agregar el Nombre <br> correo, dando un br para saltar de linea.
$ponentes_principales_presentacion = array(array("Candidato a Doctor Sergio Iker Martínez Juárez", "../../../assets/curriculums_docentes/IkerMartinez.pdf"))
...
<section class="temario container">
    ...
    <div class="secciones grid md:grid-cols-2 grid-cols-1">
        <div> <!--Tema-->
            <h3>1. Introducci&oacute;n a Python</h3>
            <div class="contenido">
                <h4>Temas</h4>
                <ul>
                    <li>a) Variables</li>
                    <li>b) Tipos de datos</li>
                    <li>c) Operadores y expresiones</li>
                    <li>d ) Funciones</li>
                </ul>
            </div>
        </div><!--fin de tema-->
        <div> <!--Tema-->
            <h3>2. Estructuras de dato en Python</h3>
            <div class="contenido">
                <h4>Temas</h4>
                <ul>
                    <li>a) Listas, tuplas y diccionarios</li>
                    <li>b) Strings</li>
                    <li>c) Conjuntos y conjuntos inmutables</li>
                </ul>
            </div>
        </div><!--fin de tema-->
        <div> <!--Tema-->
            <h3>3. L&oacute;gica, Control de flujo y Filtering</h3>
            <div class="contenido">
                <h4>Temas</h4>
                <ul>
                    <li>a) if/else</li>
        ...
        <div> <!--Tema-->
            <h3>4. M&oacute;dulos y paquetes</h3>
            <div class="contenido">
                <h4>Temas</h4>
                <ul>
                    <li>a) Crear y utilizar m&oacute;dulos</li>
                    <li>b) Instalar y utilizar paquetes de terceros</li>
                </ul>
            </div>
        </div><!--fin de tema-->
        <div> <!--Tema-->
            <h3>5. M&oacute;dulos y paquetes para datos</h3>
            <div class="contenido">
                <h4>Temas</h4>
                <ul>
                    <li>a) Introducci&oacute;n a Numpy</li>
                    <li>b) Introducci&oacute;n a Pandas</li>
                    <li>c) Visualizaci&oacute;n de datos con Matplotlib</li>
                </ul>
            </div>
        </div><!--fin de tema-->
        <div> <!--Tema-->
            <h3>6. Importando Datos en Python</h3>
            <div class="contenido">
                <h4>Temas</h4>
                <ul>
                    <li>a) Conectar a una base de datos</li>
                    <li>b) Ejecutar consultas SQL</li>
                    <li>c) Crear, actualizar y eliminar registros</li>
                </ul>
            </div>
        </div><!--fin de tema-->
