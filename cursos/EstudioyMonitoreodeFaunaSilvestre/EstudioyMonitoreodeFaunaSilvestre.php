...
<section class="oferta-academica md:py-20">
    <div class="container">
        ...
        <h2 class="mt-4">IMPORTANE</h2>
        <P>Asiste a la <b>sesión informativa</b> para despejar tus dudas, el viernes 9 de junio a las 12 horas, con la
            siguiente liga de Zoom:</P>
        <a class="btn btn-link text-indigo-600 hover:text-red-600 after:bg-indigo-600 duration-500 ease-in-out"
            href="https://cuaieed-unam.zoom.us/j/81922914599" target="_blank">
            https://cuaieed-unam.zoom.us/j/81922914599 <br>
        </a>
    </div>
</section>
...
<section class="temario container">
    ...
    <div class="secciones grid md:grid-cols-2 grid-cols-1">
        <div> <!--Tema-->
            <h3>I. Fauna silvestre tropical</h3>
            <div class="contenido">
                <h4>Temas</h4>
                <ul>
                    <li>I.1 Introducción y conceptos básicos de estudio de la fauna silvestre </li>
                </ul>
            </div>
        </div><!--fin de tema-->
        <div> <!--Tema-->
            <h3>II. Herpetofauna</h3>
            <div class="contenido">
                <h4>Temas</h4>
                <ul>
                    <li>II.1 Generalidades de anfibios</li>
                    <li>II.2 Generalidades de reptiles</li>
                    <li>II.3 Dise&ntilde;os de muestreo</li>
                    <li>II.4 Riqueza de especies</li>
                    <li>II.5 T&eacute;cnicas de observaci&oacute;n y equipo de campo para casos de estudio</li>
                    <li>II.6 T&eacute;cnicas de identificaci&oacute;n en campo</li>
                </ul>
            </div>
        </div><!--fin de tema-->
        <div> <!--Tema-->
            ...
            <div class="contenido">
                <h4>Temas</h4>
                <ul>
                    <li>III.1 Generalidades de aves</li>
                    <li>III.2 Dise&ntilde;os de muestreo</li>
                    <li>III.3 Riqueza de especies</li>
                    <li>III.4 T&eacute;cnicas de observaci&oacute;n para el estudio de aves</li>
                    <li>III.5 T&eacute;cnicas de identificaci&oacute;n en campo</li>
                </ul>
            </div>
        </div><!--fin de tema-->
        <div> <!--Tema-->
            ...
            <div class="contenido">
                <h4>Temas</h4>
                <ul>
                    <li>IV.1 Generalidades de mam&iacute;feros</li>
                    <li>IV.2 Dise&ntilde;os de muestreo</li>
                    <li>IV.3 Riqueza de especies</li>
                    <li>IV.4 T&eacute;cnicas de trampeo y manipulaci&oacute;n de peque&ntilde;os mam&iacute;feros</li>
                    <li>IV.5 T&eacute;cnicas de fototrampeo</li>
                    <li>IV.6 T&eacute;cnicas de registros directos e indirectos de mam&iacute;feros medianos y grande
                    </li>
                    <li>IV.7 T&eacute;cnicas de identificaci&oacute;n en campo</li>
                </ul>
            </div>
        </div><!--fin de tema-->
        <div> <!--Tema-->
            <h3>V. Evaluación inicial, final y clausura</h3>
        </div><!--fin de tema-->
