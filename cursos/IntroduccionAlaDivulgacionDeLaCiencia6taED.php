    ...
    <section class="relative md:py-20 py-16 overflow-hidden">
        <div class="container">
            <div class="grid grid-cols-1">
                ...
                <p class="mb-3">El curso busca introducir a los participantes las bases de la divulgación científica o
            ...
            <div class="grid grid-cols-1">
                ...
                <p class=" mb-3">Que los participantes comprendan las bases generales para hacer divulgación científica.
                </p>
            </div><!--end grid-->
            ...
            <div class="grid grid-cols-1">
                ...
                <p class=" mb-3"> Académicos, profesores, comunicadores y todo aquel interesado en divulgar ideas
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-1 gap-[30px]">
                ...
                <div class="text-center px-6 mt-6">
                    ...
                    <div class="content mt-7">
                        ...
                        <p class="text-slate-400 mt-3">Algún dispositivo para tomar clase.</p>
                    ...
                    <div class="grid lg:grid-cols-2 md:grid-cols-2 mt-8 gap-[30px]">
                        <div
                            ...
                            <div class="flex mb-5">
                                ...
                                <span class="price text-4xl font-semibold mb-0">2,600</span>
                        ...
                        <div
                            ...
                            <div class="flex mb-5">
                                <span class="text-xl font-semibold">$</span>
                                <span class="price text-4xl font-semibold mb-0">2,200</span>
                                <span class="text-xl font-semibold self-end mb-1">MXN</span>
                            </div>

                            <ul class="list-none text-slate-400">
                                <li class="mb-1 flex"><i
                                        class="uil uil-check-circle text-indigo-600 text-xl mr-2"></i>Alumnos,
    ...
    <section class="relative md:py-10 py-10">
        ...
        <div class="container">
            ...
            <div class="grid md:grid-cols-2 grid-cols-1 pt-6 gap-[30px]">
                ...
                <div>
                    <h5 class="text-lg uppercase font-semibold mb-5">II. La importancia de una cultura científica en la
                        sociedad
                    </h5>
                        ...
                        <table class="w-full text-left">
                            ...
                            <tbody>
                                <tr class="border-t border-gray-100 dark:border-gray-700">
                                    <td class="p-4"><i class="uil uil-clipboard-alt"></i> II.1 Historia de la
                                        divulgación
                                    </td>
                ...
                <div>
                    <h5 class="text-lg uppercase font-semibold mb-5">III. La ciencia que requiere un ciudadano</h5>
                ...
                <div>
                    <h5 class="text-lg uppercase font-semibold mb-5">IV. Divulgación</h5>
                ...
                <div>
                    <h5 class="text-lg uppercase font-semibold mb-5">V. Públicos</h5>
                ...
                <div>
                    <h5 class="text-lg uppercase font-semibold mb-5">VI. Medios</h5>
                ...
                <div>
                    <h5 class="text-lg uppercase font-semibold mb-5">VII. Escribir</h5>
                ...
                <div>
                    <h5 class="text-lg uppercase font-semibold mb-5">VIII. Evaluación</h5>
                ...
                <div>
                    <h5 class="text-lg uppercase font-semibold mb-5">IX. Revisión de trabajos</h5>
                </div>
            </div>
        </div>
    </section>
            ...
            <div>
                <div class="relative shadow dark:shadow-gray-800 rounded-md overflow-hidden mt-4">
                    ...
                    <div id="info-admin" class="hidden" aria-labelledby="info-admin-col">
                        <div class="p-5">
                            <p class="text-slate-400 dark:text-gray-400">Fundación UNAM<br>
                                Correo electrónico: cursosydiplomados@funam.mx<br>
                                Correo electrónico: educacioncontinua@ciencias.unam.mx<br>
            ...
            <div>
                <div class="relative shadow dark:shadow-gray-800 rounded-md overflow-hidden mt-4">
                    ...
                    <div id="info-acad" class="hidden" aria-labelledby="info-acad-col">
                        <div class="p-5">
                            <p class="text-slate-400 dark:text-gray-400">M. en C. Patricia Magaña Rueda<br>
                                Correo electrónico: patricia.magana@ciencias.unam.mx</p>
                        </div>
                    </div>
                </div>
            </div>
